...
<head>
    ...
    <!--     Fonts and icons     -->
    <link href="{{ asset('argon-dashboard-master/https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700') }}"
        rel="stylesheet" />
    <!-- Nucleo Icons -->
    ...
    <!-- Font Awesome Icons -->
    <script src="{{ asset('argon-dashboard-master/https://kit.fontawesome.com/42d5adcbca.js') }}" crossorigin="anonymous">
    </script>
    <link href="{{ asset('argon-dashboard-master/assets/css/nucleo-svg.css') }}" rel="stylesheet" />
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ asset('argon-dashboard-master/assets/css/argon-dashboard.css?v=2.0.4') }}"
        rel="stylesheet" />
</head>
    ...
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0"
                href="{{ asset('argon-dashboard-master/https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html') }}"
                target="_blank">
                <img src="{{ asset('argon-dashboard-master/assets/img/logo-ct-dark.png" class="navbar-brand-img h-100') }}"
                    alt="main_logo">
        ...
        <div class="sidenav-footer mx-3 ">
            <div class="card card-plain shadow-none" id="sidenavCard">
                <img class="w-50 mx-auto"
                    src="{{ asset('argon-dashboard-master/assets/img/illustrations/icon-documentation.svg') }}"
                ...
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        <li class="nav-item d-flex align-items-center">
                            <a href="{{ asset('argon-dashboard-master/javascript:;') }}"
                        ...
                        <li class="nav-item d-xl-none ps-3 d-flex align-items-center">
                            <a href="{{ asset('argon-dashboard-master/javascript:;') }}"
                                class="nav-link text-white p-0" id="iconNavbarSidenav">
                        ...
                        <li class="nav-item dropdown pe-2 d-flex align-items-center">
                            <a href="{{ asset('argon-dashboard-master/javascript:;') }}"
                                class="nav-link text-white p-0" id="dropdownMenuButton" data-bs-toggle="dropdown"
                                aria-expanded="false">
                            ...
                            <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4"
                                ...
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md"
                                        href="{{ asset('argon-dashboard-master/javascript:;') }}">
                                ...
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md"
                                        ...
                                        <div class="d-flex py-1">
                                            <div class="my-auto">
                                                <img src="{{ asset('argon-dashboard-master/assets/img/small-logos/logo-spotify.svg') }}"
